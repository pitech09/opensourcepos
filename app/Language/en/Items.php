...
return [
    ...
    "expiring_in_days"                   => "Expiring in {0} days",
    "expired"                            => "Expired",
    "expired_items"                      => "Expired Items",
    "expiring_soon_items"                => "Items Expiring Within 30 Days",
    "expiry_warning"                     => "Warning: The following items are expiring within 30 days or have already expired.",
    "no_expiring_items"                  => "No items are expiring soon.",
    ...
    "unit_price_required"                => "Unit Price is a required field.",
    "pricing_method"                     => "Pricing Method",
    "use_global_pricing"                 => "Use Global Default",
    "margin_percent"                     => "Profit Margin %",
    "markup_percent"                     => "Markup %",
    "pricing_help"                       => "With a global default of margin, the selling price is calculated as cost / (1 - margin / 100). With markup it is cost * (1 + markup / 100). Leave the method on \"Use Global Default\" to follow the settings in Configuration, or enter the selling price manually to override the calculation.",
    "gross_profit"                       => "Gross Profit",
    "upc_database"                       => "Barcode Database",
    "update"                             => "Update Item",
    "use_inventory_menu"                 => "Use Inventory Menu",
    "batches"                            => "Item Batches (FIFO)",
    "batch"                              => "Batch",
    "received"                           => "Received Qty",
    "remaining"                          => "Remaining Qty",
    "batch_value"                        => "Stock Value (at selling price)",
    "received_at"                        => "Received At",
    "batch_depleted"                     => "depleted",
    "no_batches"                         => "No batches recorded yet. Batches are created automatically when stock is received."
];
